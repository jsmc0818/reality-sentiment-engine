> Archive: this describes the index context and legacy research. The stock dashboard uses the separate expectations-v1 methodology in README.md. The arithmetic gap is no longer displayed or interpreted as mispricing.

# Legacy index context methodology
